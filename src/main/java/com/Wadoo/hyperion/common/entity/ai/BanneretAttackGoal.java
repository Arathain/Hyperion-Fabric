...
public class BanneretAttackGoal extends Goal {
    ...
    public boolean canStart() {
        if(this.entity.getTarget() != null){
            if(this.entity.squaredDistanceTo(this.entity.getTarget()) < 15.0D){
    ...
    public void checkAndAttack(BasaltBanneretEntity entity, LivingEntity target){
        if(this.entity.squaredDistanceTo(target) < this.getAttackReachSqr(this.entity)){
    ...
    protected double getAttackReachSqr(LivingEntity p_179512_1_) {
        return (double)(this.entity.getWidth() * 2.0F * this.entity.getWidth() * 2.0F + p_179512_1_.getWidth());
    }
}
