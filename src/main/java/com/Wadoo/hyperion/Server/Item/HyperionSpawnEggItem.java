...
public class HyperionSpawnEggItem extends SpawnEggItem {
    ...
    protected static final List<HyperionSpawnEggItem> UNADDED_EGGS = new ArrayList<HyperionSpawnEggItem>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public HyperionSpawnEggItem(final NonNullSupplier<? extends EntityType<?>> entityTypeSupplier, final int primaryColour,
    ...
    public HyperionSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColour,
                                final int secondaryColour, final Item.Properties properties) {
        super(null, primaryColour, secondaryColour, properties);
        this.entityTypeSupplier = Lazy.of(entityTypeSupplier::get);
        UNADDED_EGGS.add(this);
    ...
    public static void SpawnEggsRegister() {
